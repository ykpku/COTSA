...
from model.param_transe import *
from model.test_funcs_transe import eval_alignment, eval_alignment_mul, eval_alignment_multi_embed
...
class KGE_Model:
    ...
    def test(self, selected_pairs=None):
        ...
        prec_set, prec_result = eval_alignment_multi_embed(refs1_embed, refs2_embed, P.ent_top_k, selected_pairs, mess="ent alignment")
        t2 = time.time()
